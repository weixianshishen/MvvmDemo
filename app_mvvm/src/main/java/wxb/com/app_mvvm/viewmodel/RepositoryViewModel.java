...
import wxb.com.app_mvvm.model.User;
...
public class RepositoryViewModel implements ViewModel {
    ...
    public ObservableField<Drawable> backgroundImg;
    ...
    public RepositoryViewModel(Context context, final Repository repository) {
        ...
        this.backgroundImg = new ObservableField<>(context.getResources().getDrawable(R.drawable.octocat));
